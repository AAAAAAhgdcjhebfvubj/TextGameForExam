...
public class MainActivity extends AppCompatActivity {
    private Character student; // персонаж
    ...
    private void updateStatus() {
        ...
        // состоянием дел
        student.L += story.current_situation.dL;
        student.R += story.current_situation.dR;
        student.P += story.current_situation.dP;
        // выводим статус на форму.
        ((TextView) findViewById(R.id.status)).
                setText("Учеба:" + student.L +
                        "\nПерспектива:" + student.P + "\nРепутация:" + student.R);
